    ...
    <div class="picker" :class="{ 'picker-3d': rotateEffect }">
      ...
      <div class="picker-items">
        <picker-slot v-for="slot in slots" :valueKey='valueKey' :values="slot.values || []"
                     ...
                     :class-name="slot.className" :flex="slot.flex || '1'" v-model="values[slot.valueIndex]"
                     :rotate-effect="rotateEffect" :divider="slot.divider" :content="slot.content"></picker-slot>
